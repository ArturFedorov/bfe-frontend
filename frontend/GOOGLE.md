...
_"Implement X from scratch" — tests if you understand what your tools actually do_

| #   | Task                                                   | Difficulty | Frequency | Done |
| --- | ------------------------------------------------------ | ---------- | --------- | ---- |
...
_Build in HTML/CSS/JS with no frameworks — this IS the Google frontend round_

| #   | Task                                   | Difficulty | Frequency | Notes                   | Done |
| --- | -------------------------------------- | ---------- | --------- | ----------------------- | ---- |
...
_Tests whether you actually understand the platform, not just the framework_
...
_"What does this print?" — tests deep language knowledge_
...
_35–45 min design discussion — architecture, API design, state management, performance, accessibility, i18n_
