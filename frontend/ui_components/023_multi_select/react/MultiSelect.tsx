/**
 * Multi-Select Dropdown — React implementation.
 *
...
export default function MultiSelect(_props: MultiSelectProps) {
  return (
    <div
      style={{
    ...
    >
      ...
      <p style={{ margin: '0.5rem 0 0' }}>
        Not implemented yet — build me in <code>MultiSelect.tsx</code>.
      </p>
    </div>
  );
}
