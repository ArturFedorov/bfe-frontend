/**
 * Data Table with Sort & Filter — React implementation.
 *
...
export default function DataTable(_props: DataTableProps) {
  return (
    <div
      style={{
    ...
    >
      <strong>Data Table with Sort & Filter</strong>
      <p style={{ margin: '0.5rem 0 0' }}>
        Not implemented yet — build me in <code>DataTable.tsx</code>.
      </p>
    </div>
  );
}
