/**
 * Virtual Scroll List — React implementation.
 *
...
export default function VirtualScroll(_props: VirtualScrollProps) {
  return (
    <div
      style={{
    ...
    >
      <strong>Virtual Scroll List</strong>
      <p style={{ margin: '0.5rem 0 0' }}>
        Not implemented yet — build me in <code>VirtualScroll.tsx</code>.
      </p>
    </div>
  );
}
