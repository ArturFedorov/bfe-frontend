/**
 * Form with Validation — React implementation.
 *
...
export default function FormValidation(_props: FormValidationProps) {
  return (
    <div
      style={{
    ...
    >
      ...
      <p style={{ margin: '0.5rem 0 0' }}>
        Not implemented yet — build me in <code>FormValidation.tsx</code>.
      </p>
    </div>
  );
}
