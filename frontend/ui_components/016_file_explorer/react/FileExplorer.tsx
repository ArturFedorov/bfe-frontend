/**
 * File Explorer — React implementation.
 *
...
export default function FileExplorer(_props: FileExplorerProps) {
  return (
    <div
      style={{
    ...
    >
      ...
      <p style={{ margin: '0.5rem 0 0' }}>
        Not implemented yet — build me in <code>FileExplorer.tsx</code>.
      </p>
    </div>
  );
}
