...
- **Component to implement:** [`react/ToggleSwitch.tsx`](./react/ToggleSwitch.tsx) — currently a placeholder.
...
Then open the dev server and pick **Toggle Switch** from the sidebar.

### Goal

Re-implement the component in **idiomatic React** so it meets the same
requirements described above. Edit `react/ToggleSwitch.tsx`; keep its exported props
