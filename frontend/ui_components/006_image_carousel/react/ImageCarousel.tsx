/**
 * Image Carousel — React implementation.
 *
...
export default function ImageCarousel(_props: ImageCarouselProps) {
  return (
    <div
      style={{
    ...
    >
      ...
      <p style={{ margin: '0.5rem 0 0' }}>
        Not implemented yet — build me in <code>ImageCarousel.tsx</code>.
      </p>
    </div>
  );
}
